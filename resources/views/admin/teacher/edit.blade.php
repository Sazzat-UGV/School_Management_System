        ...
        <div class="col-12 mx-auto">
            ...
            <div class="card">
                <div class="card-body p-4">
                    <form action="{{ route('teacher.update',['teacher'=>$teacher->id]) }}" method="POST" class="row g-3" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="col-md-6">
                            ...
                            is-invalid
                        @enderror"
                                id="first_name" placeholder="Enter first name" value="{{ old('first_name',$teacher->name) }}">
                            @error('first_name')
                        ...
                        <div class="col-md-6">
                            ...
                            is-invalid
                        @enderror"
                                id="last_name" placeholder="Enter last name" value="{{ old('last_name',$teacher->last_name) }}">
                            @error('last_name')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            is-invalid
                        @enderror"
                                id="date_of_birth" placeholder="Enter date of birth" value="{{ old('date_of_birth',$teacher->dob) }}">
                            @error('date_of_birth')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        ...
                        @enderror"
                                ...
                                value="{{ old('date_of_joining',$teacher->date_of_joining) }}">
                        ...
                        <div class="col-md-4">
                            ...
                            is-invalid
                        @enderror"
                                id="mobile_number" placeholder="Enter mobile number" value="{{ old('mobile_number',$teacher->phone) }}">
                            @error('mobile_number')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            is-invalid
                        @enderror"
                                id="marital_status" placeholder="Enter marital status" value="{{ old('marital_status',$teacher->marital_status) }}">
                        ...
                        <div class="col-md-6">
                            ...
                            is-invalid
                        @enderror"
                                cols="30" rows="3" id="current_address" placeholder="Enter current address">{{ old('current_address',$teacher->address) }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            is-invalid
                        @enderror"
                                cols="30" rows="3" id="permanent_address" placeholder="Enter permanent address">{{ old('permanent_address',$teacher->permanent_address) }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            is-invalid
                        @enderror"
                                cols="30" rows="3" id="qualification" placeholder="Enter qualification">{{ old('qualification',$teacher->qualification) }}</textarea>
                            @error('qualification')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            is-invalid
                        @enderror"
                                cols="30" rows="3" id="work_experience" placeholder="Enter work experience">{{ old('work_experience',$teacher->work_experience) }}</textarea>
                        ...
                        <div class="col-md-12">
                            ...
                            is-invalid
                        @enderror"
                                cols="30" rows="3" id="note" placeholder="Enter note">{{ old('note',$teacher->note) }}</textarea>
                            @error('note')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            is-invalid
                        @enderror"
                                id="email" placeholder="Enter email" value="{{ old('email',$teacher->email) }}">
                            @error('email')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="file" name="photo" data-default-file="{{ asset('uploads/profile') }}/{{ $teacher->photo }}"
