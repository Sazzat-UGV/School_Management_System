        ...
        <div class="col-12 mx-auto">
            ...
            <div class="card">
                <div class="card-body p-4">
                    <form action="{{ route('student.update',['student'=>$student->id]) }}" method="POST" class="row g-3" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="col-md-6">
                            ...
                            is-invalid
                        @enderror"
                                id="first_name" placeholder="Enter first name" value="{{ old('first_name',$student->name) }}">
                            @error('first_name')
                        ...
                        <div class="col-md-6">
                            ...
                            is-invalid
                        @enderror"
                                id="last_name" placeholder="Enter last name" value="{{ old('last_name',$student->last_name) }}">
                            @error('last_name')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            is-invalid
                        @enderror"
                                id="admission_number" placeholder="Enter admission number" value="{{ old('admission_number',$student->admission_number) }}">
                        ...
                        <div class="col-md-4">
                            ...
                            is-invalid
                        @enderror"
                                id="roll_number" placeholder="Enter roll number" value="{{ old('roll_number',$student->roll_number) }}">
                            @error('roll_number')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            @enderror"
                                ...
                                @foreach ($classes as $class)
                                    <option value="{{ $class->id }}" @if (old('class') == $class->id) selected @elseif($class->id == $student->class_id) selected @endif>
                                        {{ $class->name }}</option>
                                @endforeach
                            </select>
                            @error('class')
                        ...
                        <div class="col-md-3">
                            ...
                            is-invalid
                        @enderror "
                                id="date_of_birth" placeholder="Date of Birth" value="{{ old('date_of_birth',$student->dob) }}">
                            @error('date_of_birth')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            is-invalid
                        @enderror"
                                id="caste" placeholder="Enter caste" value="{{ old('caste',$student->caste) }}">
                            @error('caste')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            is-invalid
                        @enderror"
                                id="religion" placeholder="Enter religion" value="{{ old('religion',$student->religion) }}">
                            @error('religion')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            is-invalid
                        @enderror"
                                id="mobile_number" placeholder="Enter mobile number" value="{{ old('mobile_number',$student->phone) }}">
                            @error('mobile_number')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            is-invalid
                        @enderror "
                                id="admission_date" placeholder="admission date" value="{{ old('admission_date',$student->admission_date) }}">
                        ...
                        <div class="col-md-4">
                            ...
                            @enderror"
                                ...
                                <option value="B-" @if (old('blood_group',$student->blood_group) == 'B-') selected @endif>B-</option>
                                <option value="O+" @if (old('blood_group',$student->blood_group) == 'O+') selected @endif>O+</option>
                                <option value="O-" @if (old('blood_group',$student->blood_group) == 'O-') selected @endif>O-</option>
                                <option value="AB+" @if (old('blood_group',$student->blood_group) == 'AB+') selected @endif>AB+</option>
                                <option value="AB-" @if (old('blood_group',$student->blood_group) == 'AB-') selected @endif>AB+</option>
                            </select>
                            @error('blood_group')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        ...
                        <div class="col-md-4">
                            ...
                            is-invalid
                        @enderror"
                                id="height" placeholder="Enter height" value="{{ old('height',$student->height) }}">
                            @error('height')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            is-invalid
                        @enderror"
                                id="weight" placeholder="Enter weight" value="{{ old('weight',$student->weight) }}">
                            @error('weight')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            is-invalid
                        @enderror"
                                id="address" placeholder="Enter address" value="{{ old('address',$student->address) }}">
                            @error('address')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            is-invalid
                        @enderror"
                                id="photo" placeholder="Enter photo" data-default-file="{{ asset('uploads/profile') }}/{{ $student->photo }}">
                            @error('photo')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
