        ...
        <div class="col-12 mx-auto">
            ...
            <div class="card">
                <div class="card-body p-4">
                    <form action="{{ route('teacherProfileUpdate',['id'=>Auth::user()->id])}}" method="POST" class="row g-3" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            is-invalid
                        @enderror"
                                id="date_of_birth" placeholder="Enter date of birth" value="{{ old('date_of_birth',Auth::user()->dob) }}">
                            @error('date_of_birth')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            is-invalid
                        @enderror"
                                id="marital_status" placeholder="Enter marital status" value="{{ old('marital_status',Auth::user()->marital_status) }}">
